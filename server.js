...
app.get('/rekhansikadetails', async (req, res) => {
    try {
...
app.listen(3030,async()=>{
    try {
        await mongoose.connect("mongodb+srv://rekhansikagoluguri07:TouxjD8S0KOZVNbF@cluster1.9cw6b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1")
